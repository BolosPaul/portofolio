  ...
  const sosmeds = [
    {
      ...
      link: "https://www.tiktok.com/@bolospaul",
    },
    {
      name: "Github",
      icon: <FiGithub size={20} />,
      link: "https://github.com/BolosPaul",
    },
    {
      name: "Instagram",
      icon: <FiInstagram size={20} />,
      link: "https://www.instagram.com/bolos_paul/",
    },
    {
      name: "Linkedin",
      icon: <FiLinkedin size={20} />,
      link: "https://www.linkedin.com/in/bolos-paul-baa218257/",
    },
  ];
  return (
      ...
      <div className="fixed bottom-0 right-0 w-[105px]">
        <div className="flex flex-col items-center" data-aos="fade-up">
          <div data-aos="fade-left" data-aos-duration="600">
            <a
              href="mailto:bolospaul7@gmail.com"
