    ...
    <section className="flex h-[650px] w-full flex-col items-center justify-center py-24 text-center">
      ...
      <div className="z-40 mb-0 md:mb-10">
        ...
        >
          Building Reliable,
          <br />
          Scalable & Efficient Backend Solutions.
        </h2>
        <p
          ...
          data-aos-duration="300"
        >
          I specialize in developing robust server-side applications, focusing
          on optimizing performance, security, and scalability for modern
          digital experiences.
        </p>
      </div>
